...
def get_filters():
    ...
    # get user input for city (chicago, new york city, washington). HINT: Try and Use a while loop to handle invalid inputs
...
Pull_no_of_records = 5

while True:

  raw_input_data = input('Let me know if you would you like to see 5 rows of data data?\nPlease select yes or no.').lower()

  if (raw_input_data == 'yes'):

    print(df.iloc[Pull_no_of_records],'\n')

    Pull_no_of_records+=5

    continue

  elif (raw_input_data == 'no'):
